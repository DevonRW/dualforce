...
<script lang="ts">
  export default {
    ...
    methods: {
      getImage(card : Object) : string {
        return `https://static.dcdualforce.gg/cards/${card.slug}.png`
      }
    }
  }
</script>